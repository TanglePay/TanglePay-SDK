...
export const ethGetBlockByNumber = async (blockHashOrBlockNumber:BlockNumber | string , returnTransactionObjects:boolean) => {
    // @ts-ignore
...
// eth_personal_sign
export const ethPersonalSign = async (dataToSign:string, address:string, password:string) => {
